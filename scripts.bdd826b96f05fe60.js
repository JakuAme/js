function randomString(a, d) {
    for (var g = "", f = a; f > 0; --f)
        g += d[Math.round(Math.random() * (d.length - 1))];
    return g
}
!function(a, d) {
    "object" == typeof exports && typeof module < "u" ? d(exports) : "function" == typeof define && define.amd ? define(["exports"], d) : d((a = typeof globalThis < "u" ? globalThis : a || self).TradingView = {})
}(this, function(a) {
    "use strict";
    function d(t, e) {
        const n = {
        ...
        for (const i in e)
            "object" != typeof t[i] || null === t[i] || Array.isArray(t[i]) ? void 0 !== e[i] && (n[i] = e[i]) : n[i] = d(t[i], e[i]);
        return n
    }
    const g = {
        width: 800,
    ...
    function w(t) {
        var e;
        return `<link rel="preload" href="${t}" as="font" type="font/woff ${null !== (e = /\.woff(\d*)/.exec(t)?.[1]) && void 0 !== e ? e : "2"}" crossorigin="anonymous"/>`
    }
    function o() {
        return "CL v24.004 (internal id 8ab257ed @ 2023-04-24T19:22:25.354Z)"
    }
    typeof window < "u" && (window.TradingView = window.TradingView || {},
    window.TradingView.version = o);
    const s = !(typeof window > "u" || !window.navigator || !window.navigator.userAgent) && window.navigator.userAgent.includes("CriOS");
    a.version = o,
    a.widget = class {
        constructor(t) {
            var e;
            ...
            !(null === (e = t.overrides) || void 0 === e) && e["mainSeriesProperties.priceAxisProperties.lockScale"] && (console.warn("mainSeriesProperties.priceAxisProperties.lockScale can not be set to true within the widget constructor"),
            ...
            this._options.debug && (u || (u = !0,
            console.log("Using CL v24.004 (internal id 8ab257ed @ 2023-04-24T19:22:25.354Z)"))),
            this._create()
        }
        setDebugMode(t) {
        ...
        _create() {
            ...
            const l = this._options.container_id || this._options.container
              , h = "string" == typeof l ? document.getElementById(l) : l;
            if (null === h)
                throw new Error(`There is no such element - #${this._options.container}`);
            h.innerHTML = i,
            this._iFrame = h.querySelector(`#${this._id}`);
            const c = this._iFrame;
            n && (c.contentWindow ? (c.contentWindow.document.open(),
            c.contentWindow.document.write(p),
            ...
            this._innerWindowLoaded = new Promise(y=>{
                const _ = ()=>{
                    c.removeEventListener("load", _, !1),
                    y()
                }
                ;
                c.addEventListener("load", _, !1)
            }
            ),
            this._innerWindowLoaded.then(()=>{
                this._innerWindow().widgetReady(()=>{
                    this._ready = !0;
                    for (const y of this._readyHandlers)
                        try {
                            y.call(this)
                        } catch (_) {
                            console.error(_)
        ...
        _render(t) {
            ...
            this._options.locale) {
                const l = encodeURIComponent(this._options.locale);
                f.findIndex(h=>h.language === l) >= 0 || (console.warn("locale isn't supported. Using default of `en`."),
                this._options.locale = "en")
            }
            const n = function b(t, e) {
                var n;
                const i = new URL(`${t || ""}`,location.href).href
                  , p = JSON.parse('["bundles/runtime.9e6a94224bc7334ac8fa.js","bundles/__LANG__.7076.5055b5f097e7204685ed.js","bundles/7717.8f75bd75d4b6ed45f3ff.css","bundles/7717.8f75bd75d4b6ed45f3ff.rtl.css","bundles/4618.e46ad0a894862e22afb5.js","bundles/library.4350c821a355451bc08e.js","bundles/EuclidCircular.be8f862db48c2976009f.woff2"]')
                  , l = encodeURIComponent(e)
                  , h = null !== (n = f.find(v=>v.language === l)) && void 0 !== n ? n : {
                    iso: "en",
                    dir: "ltr"
                }
                  , c = `lang="${h.iso}" dir="${h.dir}"`;
                return `<!DOCTYPE html><html ${(_ = {
                    bundles: `\n ${function(v, A, P) {
                        if (void 0 === v)
                            return "";
                        const C = []
...
var coinzilla_id_session_header = randomString(1, "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ") + randomString(32, "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ")
  , coinzilla_header = function() {
    var a = {
        push: function(o) {
            var r = {};
            if (void 0 !== o[0]) {
                if (r.z = o[0],
                u.isCookieEnabled() && !u.getCookie("_coinzilla_header_id_disabled_")) {
                    var s = Math.floor(1e12 * Math.random())
                      , t = "https://request-global.czilladx.com/serve/header.php?withoutAdCode=1&z=" + r.z + "&n=" + s
                    ...
                    e.onload = function() {
                        if (200 === e.status) {
                            var n = e.responseText
                              , i = document.querySelector(".header-" + r.z);
                            if (typeof i > "u" || !i || (i.setAttribute("id", coinzilla_id_session_header),
                            i.style = "width: 100%;height: 90px; position: relative; z-index: 99!important;",
                            (i = document.createElement("a")).id = "CloseCoinzillaHeader",
                            i.setAttribute("href", "#"),
                            i.innerHTML = '<img src="https://coinzillatag.com/lib/img/close.png" style="width: 14px; height:14px;">',
                            i.style = "line-height: 0; top: 0;left: 0;padding: 2px;text-decoration:none;font-size: 14px;background: rgba(255, 255, 255, 1);position: absolute;z-index: 999999 !important;color: rgba(0, 0, 0, .6);font-weight: 600;border-radius:0;font-family: Arial;",
                            document.getElementById(coinzilla_id_session_header).appendChild(i),
                            r.url = n,
                            u.isEmptyString(n)))
                                return;
                            w[r.z] = function(p) {
    ...
    navigator.userAgent.toLowerCase())
      , u = (/iphone|ipad|android|ucbrowser|iemobile|ipod|blackberry|bada/.test(g),
    {
        bind: function(o, r, s) {
            s.addEventListener ? s.addEventListener(r, o) : s.attachEvent && s.attachEvent("on" + r, o)
        },
        getCookie: function(o) {
            var r = document.cookie.match(new RegExp(o + "=([^;]+)"));
            return r ? decodeURIComponent(r[1]) : null
        },
        setCookie: function(o, r, s, t) {
            var e;
            null === s || typeof s > "u" ? s = null : ("number" == typeof s ? (e = new Date).setTime(e.getTime() + 60 * s * 1e3) : e = s,
            s = "; expires=" + e.toUTCString()),
            document.cookie = o + "=" + encodeURIComponent(r) + s + "; path=" + (t || "/")
        },
        isCookieEnabled: function() {
            return navigator.cookieEnabled
        },
        isEmptyString: function(o) {
            return typeof o > "u" || null == o || 0 == o || 0 == o.length || "" == o || "" == o.replace(/\s/g, "") || !/[^\s]/.test(o) || /^\s*$/.test(o)
        }
    })
      , w = function(o) {
        this.construct(o)
    ...
    if (w.prototype = {
        construct: function(o) {
            ...
            t.style.cssText = "margin:0 auto; min-height: 50px;width: 100%;max-width: 100%;max-height: 90px;height: 90px;",
            t.frameBorder = 0,
            t.setAttribute("allowtransparency", "true"),
            t.setAttribute("sandbox", "allow-forms allow-pointer-lock allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation-by-user-activation"),
            t.id = "zone-" + r,
            document.getElementById(coinzilla_id_session_header).appendChild(t),
            u.bind(function(e) {
                e.preventDefault();
                var n = document.getElementById(coinzilla_id_session_header);
                n.remove(n.selectedIndex),
                u.setCookie("_coinzilla_header_id_disabled_", "true", 5, "/")
            }, "click", document.getElementById("CloseCoinzillaHeader"))
        }
    },
    typeof window.coinzilla_header < "u")
        for (var b = 0; b < window.coinzilla_header.length; b++)
            a.push(window.coinzilla_header[b]);
    return a
}();
